...
const AnalyticsDashboardPage = () => {
  const [analyticsData] = useState<AnalyticsData>({
    ...
    revenueGrowth: 8.3,
    topCities: [
      { city: "New York", orders: 234, revenue: 8567.5 },
      { city: "Los Angeles", orders: 189, revenue: 7234.2 },
      { city: "Chicago", orders: 156, revenue: 5890.3 },
      { city: "Miami", orders: 123, revenue: 4456.8 },
      { city: "Seattle", orders: 98, revenue: 3789.4 },
    ],
    topCuisines: [
      { cuisine: "Italian", orders: 345, percentage: 27.7 },
      { cuisine: "Chinese", orders: 289, percentage: 23.2 },
      { cuisine: "Mexican", orders: 234, percentage: 18.8 },
      { cuisine: "Indian", orders: 178, percentage: 14.3 },
      { cuisine: "Japanese", orders: 156, percentage: 12.5 },
      { cuisine: "Others", orders: 45, percentage: 3.6 },
    ],
    recentOrders: [
      {
        id: "ORD-001",
    ...
    monthlyData: [
      ...
      { month: "May", orders: 167, revenue: 6012 },
      { month: "Jun", orders: 189, revenue: 6804 },
      { month: "Jul", orders: 201, revenue: 7236 },
      { month: "Aug", orders: 234, revenue: 8424 },
      { month: "Sep", orders: 256, revenue: 9216 },
      { month: "Oct", orders: 278, revenue: 10008 },
      { month: "Nov", orders: 289, revenue: 10404 },
      { month: "Dec", orders: 312, revenue: 11232 },
    ],
  });
